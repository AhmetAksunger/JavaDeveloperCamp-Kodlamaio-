	...
	public List<GetAllModelsResponse> getAll() {
		...
		List<GetAllModelsResponse> modelsResponse = models.stream()
				.map(model->modelMapperService.forResponse().map(model,GetAllModelsResponse.class)).collect(Collectors.toList());
																		//brand takma isim
		//GetAllModelsResponse'ta brandName var ama Models'te brand objesi var 
		//nasıl mapleyecek? ModelMapper brandName'nin brand nesnesinin 
		//namesini kastettiğimizi anlar. 
